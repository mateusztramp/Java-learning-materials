...
class CompanyGenerator {
    ...
    List<Company> generate() {
        return fileLinesLoader.loadLinesShuffled("companies").stream()
                .limit(randomNumberOfCompanies()).map(this::generateCompany).collect(Collectors.toList());
    }
    ...
    private int randomNumberOfCompanies() {
